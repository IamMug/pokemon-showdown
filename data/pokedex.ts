export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	steelix: {
		...
		name: "Steelix",
		types: ["Steel", "Ground"],
		baseStats: {hp: 75, atk: 110, def: 200, spa: 20, spd: 75, spe: 20},
	...
	medicham: {
		...
		name: "Medicham",
		types: ["Fighting", "Psychic"],
		baseStats: {hp: 80, atk: 60, def: 75, spa: 78, spd: 75, spe: 87},
	...
	swalot: {
		...
		abilities: {0: "Liquid Ooze", 1: "Sticky Hold", H: "Remedial Ooze"},
		heightm: 1.7,
		weightkg: 80,
		color: "Purple",
		prevo: "Gulpin",
	...
	wailord: {
		...
		abilities: {0: "Blubber Guard", 1: "Thick Fat", H: "Pressure"},
		heightm: 14.5,
		weightkg: 398,
		color: "Blue",
		prevo: "Wailmer",
	...
	vespiquen: {
		...
		types: ["Bug", "Poison"],
		gender: "F",
		baseStats: {hp: 70, atk: 70, def: 110, spa: 105, spd: 110, spe: 40},
		abilities: {0: "Pressure", 1: "Queenly Majesty", H: "Levitate"},
		heightm: 1.2,
		weightkg: 38.5,
		color: "Yellow",
		prevo: "Combee",
	...
	cherubi: {
		...
		name: "Cherubi",
		types: ["Grass"],
		baseStats: {hp: 62, atk: 35, def: 45, spa: 62, spd: 53, spe: 35},
	...
	gallade: {
		...
		abilities: {0: "Heroic", 1: "Sharpness", H: "Justified"},
		heightm: 1.6,
		weightkg: 52,
		color: "White",
		prevo: "Kirlia",
	...
	zacian: {
		...
		abilities: {0: "Intrepid Sword", 1: "Heroic"},
		heightm: 2.8,
		weightkg: 110,
		color: "Blue",
		eggGroups: ["Undiscovered"],
