export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	onix: {
		...
		name: "Onix",
		types: ["Rock", "Ground"],
		baseStats: {hp: 75, atk: 100, def: 120, spa: 50, spd: 65, spe: 90},
	...
	gimmighoul: {
		...
		types: ["Ghost"],
		gender: "N",
		baseStats: {hp: 57, atk: 30, def: 85, spa: 90, spd: 81, spe: 7},
	...
	gimmighoulroaming: {
		...
		types: ["Ghost"],
		gender: "N",
		baseStats: {hp: 43, atk: 30, def: 25, spa: 93, spd: 35, spe: 1946},
		abilities: {0: "Magnet Pull"},
		heightm: 0.1,
		weightkg: 0.1,
		color: "Gray",
	...
	wem: {
		...
		types: ["Psychic", "Normal"],
		gender: "N",
		baseStats: {hp: 57, atk: 48, def: 29, spa: 54, spd: 44, spe: 53},
