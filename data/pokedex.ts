export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	ampharos: {
		...
		name: "Ampharos",
		types: ["Electric"],
		baseStats: {hp: 108, atk: 88, def: 88, spa: 134, spd: 110, spe: 72},
	...
	magcargo: {
		...
		name: "Magcargo",
		types: ["Fire", "Rock"],
		baseStats: {hp: 115, atk: 50, def: 120, spa: 135, spd: 80, spe: 50},
	...
	goodra: {
		...
		abilities: {0: "Sap Sipper", 1: "Remedial Ooze", H: "Gooey"},
		heightm: 2,
		weightkg: 150.5,
		color: "Purple",
		prevo: "Sliggoo",
	...
	wem: {
		...
		types: ["Psychic", "Normal"],
		gender: "N",
		baseStats: {hp: 57, atk: 48, def: 29, spa: 62, spd: 56, spe: 53},
