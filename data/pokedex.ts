export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	bulbasaur: {
		...
		baseStats: {hp: 90, atk: 49, def: 49, spa: 65, spd: 65, spe: 45},
	...
	ivysaur: {
		...
		types: ["Grass", "Poison"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 130, atk: 62, def: 63, spa: 80, spd: 80, spe: 60},
		abilities: {0: "Overgrow", H: "Chlorophyll"},
		heightm: 1,
		weightkg: 13,
		color: "Green",
	...
	venusaur: {
		...
		types: ["Grass", "Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 180, atk: 82, def: 83, spa: 100, spd: 100, spe: 80},
